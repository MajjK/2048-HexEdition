...
"border-color: rgb(185, 163, 126);")
        ...
        self.server_button.setGeometry(QRect(240, 10, 101, 31))
        font = QFont()
        ...
        self.load_config_button = QPushButton(self.centralwidget)
        self.load_config_button.setObjectName(u"load_config_button")
        self.load_config_button.setGeometry(QRect(130, 100, 101, 31))
        self.load_config_button.setFont(font)
        self.load_config_button.setStyleSheet(u"background-color: rgb(197, 173, 134)")
        self.save_config_button = QPushButton(self.centralwidget)
        self.save_config_button.setObjectName(u"save_config_button")
        self.save_config_button.setGeometry(QRect(20, 100, 101, 31))
        self.save_config_button.setFont(font)
        self.save_config_button.setStyleSheet(u"background-color: rgb(197, 173, 134)")
        ...
        self.connect_button.setGeometry(QRect(240, 100, 101, 31))
        ...
        self.menu_button.setGeometry(QRect(240, 50, 101, 31))
    ...
    def retranslateUi(self, MultiWindow):
        ...
        self.load_config_button.setText(QCoreApplication.translate("MultiWindow", u"Load Config", None))
        self.save_config_button.setText(QCoreApplication.translate("MultiWindow", u"Save Config", None))
