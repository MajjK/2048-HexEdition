...
################################################################################
## Form generated from reading UI file 'Hex2048_Scores.window_ui'
##
...
"border-color: rgb(185, 163, 126);")
        ...
        self.scoreboard_text.setGeometry(QRect(75, 5, 121, 31))
        font = QFont()
        ...
        self.nickname_text.setGeometry(QRect(30, 40, 81, 31))
        ...
        self.score_text.setGeometry(QRect(175, 40, 51, 31))
        ...
        self.nick_text_edit.setEnabled(True)
        self.nick_text_edit.setGeometry(QRect(10, 70, 120, 291))
        self.nick_text_edit.setFont(font)
        self.nick_text_edit.setStyleSheet(u"background-color: rgb(197, 173, 134)")
        self.nick_text_edit.setReadOnly(True)
        self.score_text_edit = QPlainTextEdit(self.centralwidget)
        self.score_text_edit.setObjectName(u"score_text_edit")
        self.score_text_edit.setEnabled(True)
        self.score_text_edit.setGeometry(QRect(140, 70, 120, 291))
        self.score_text_edit.setFont(font)
        self.score_text_edit.setStyleSheet(u"background-color: rgb(197, 173, 134)")
        self.score_text_edit.setReadOnly(True)
