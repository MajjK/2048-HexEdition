...
#Gre w trybie Singleplayer uruchamiamy przyciskiem Nowa Gra
#Gre w trybie Multiplayer uruchamiamy przyciskiem Multiplayer, następnie musimy połączyć się za pomocą klienta.
#Przed wykonaniem ruchu jako serwer musimy nacisnąć przycisk "Czekaj na Ruch" w aplikacji klienta i na odwrót.

#Gra automatycznie wczytuje konfiguracje z pliku config.json - gdy nie istnieje prosi o jej podanie a następnie ją zapisuje
#Wczytywanie stanu gry wraz z replayem działa jedynie dla jednego gracza
...
def print_hex(map):
    ...
    print("")
    print("             /  \\ /  \\ /  \\ /  \\ /  \\              ")
    print("            |"+map[0][0].return_value()+"|"+map[0][1].return_value()+"|"+map[0][2].return_value()+"|"+map[0][3].return_value()+"|"+map[0][4].return_value()+"|                  ")
    print("          /  \\ /  \\ /  \\ /  \\ /  \\ /  \\           ")
    print("         |"+map[1][0].return_value()+"|"+map[1][1].return_value()+"|"+map[1][2].return_value()+"|"+map[1][3].return_value()+"|"+map[1][4].return_value()+"|"+map[1][5].return_value()+"|                ")
    print("       /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\        ")
    print("      |"+map[2][0].return_value()+"|"+map[2][1].return_value()+"|"+map[2][2].return_value()+"|"+map[2][3].return_value()+"|"+map[2][4].return_value()+"|"+map[2][5].return_value()+"|"+map[2][6].return_value()+"|              ")
    print("    /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\     ")
    print("   |"+map[3][0].return_value()+"|"+map[3][1].return_value()+"|"+map[3][2].return_value()+"|"+map[3][3].return_value()+"|"+map[3][4].return_value()+"|"+map[3][5].return_value()+"|"+map[3][6].return_value()+"|"+map[3][7].return_value()+"|            ")
    print(" /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\  ")
    print("|"+map[4][0].return_value()+"|"+map[4][1].return_value()+"|"+map[4][2].return_value()+"|"+map[4][3].return_value()+"|"+map[4][4].return_value()+"|"+map[4][5].return_value()+"|"+map[4][6].return_value()+"|"+map[4][7].return_value()+"|"+map[4][8].return_value()+"|          ")
    print("  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  ")
    print("   |"+map[5][0].return_value()+"|"+map[5][1].return_value()+"|"+map[5][2].return_value()+"|"+map[5][3].return_value()+"|"+map[5][4].return_value()+"|"+map[5][5].return_value()+"|"+map[5][6].return_value()+"|"+map[5][7].return_value()+"|            ")
    print("     \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /     ")
    print("      |"+map[6][0].return_value()+"|"+map[6][1].return_value()+"|"+map[6][2].return_value()+"|"+map[6][3].return_value()+"|"+map[6][4].return_value()+"|"+map[6][5].return_value()+"|"+map[6][6].return_value()+"|              ")
    print("        \\ /  \\ /  \\ /  \\ /  \\ /  \\ /  \\ /        ")
    print("         |"+map[7][0].return_value()+"|"+map[7][1].return_value()+"|"+map[7][2].return_value()+"|"+map[7][3].return_value()+"|"+map[7][4].return_value()+"|"+map[7][5].return_value()+"|                ")
    print("           \\ /  \\ /  \\ /  \\ /  \\ /  \\ /           ")
    print("            |"+map[8][0].return_value()+"|"+map[8][1].return_value()+"|"+map[8][2].return_value()+"|"+map[8][3].return_value()+"|"+map[8][4].return_value()+"|                  ")
    print("              \\ /  \\ /  \\ /  \\ /  \\ /              ")
    print("")
...
class Game:
    ...
    def update_turn(self):
        ...
        self.update_history()
        #print_hex(self.map)
        #print("Tura gracza nr: ", self.curr_turn + 1)
