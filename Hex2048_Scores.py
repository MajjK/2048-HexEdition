...
"border-color: rgb(185, 163, 126);")
        ...
        self.scoreboard_text.setGeometry(QRect(40, 5, 121, 31))
        font = QFont()
        ...
        self.nickname_text.setGeometry(QRect(10, 40, 81, 31))
        ...
        self.score_text.setGeometry(QRect(110, 40, 51, 31))
        ...
        self.nick_text_edit.setGeometry(QRect(10, 70, 80, 250))
        ...
        self.score_text_edit.setGeometry(QRect(100, 70, 80, 250))
